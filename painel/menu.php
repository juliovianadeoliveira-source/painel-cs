...
//Opções
$Coluna_14 = array('OpcoesExportar', 'OpcoesImportar', 'OpcoesVencimento', 'OpcoesRelatorio', 'OpcoesGrupoAcesso', 'OpcoesMascaraURL', 'OpcoesCircular');
...
<div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="index.php"><span class="TituloPainel">grupo 3br</span></a>
                   ...
                   <li>
					...
					//Tutoriais
					?>
					<li class="xn-title"></span>Tutoriais</a></li>
                     
                     <li class="xn-openable">
                     <a href="#"><span class="fa fa-play-circle-o large"> </span> V&iacute;deos Tutoriais</a>
                     <ul> 
                       
					<li>
                        <a href="http:img/videos/cadastrar_login.mp4" target="_blank"><span class="fa fa-play-circle-o large"></span> Criar Usu&aacute;rios / Logins</a>
                    </li>
                                       <li><a href="http:img/videos/criar_teste_e_depois_ativar.mp4" target="_blank"><span class="fa fa-play-circle-o large"></span>  Criar Testes e Ativar Login</a></li>
                                      <li><a href="http:img/videos/alterar_data_vencimento.mp4" target="_blank"><span class="fa fa-play-circle-o large"></span>  Atualizar Data e Renovar</a></li>
                                        <li><a href="http:img/videos/dar_permissoes_revendas.mp4" target="_blank"><span class="fa fa-play-circle-o large"></span>  Criar Permiss&otilde;es para Revendedores</a></li>
                                        <li><a href="http:img/videos/criar_teste_automatico.mp4" target="_blank"><span class="fa fa-play-circle-o large"></span>  Criar e Configurar Testes Autom&aacute;ticos</a></li>
                                        <li><a href="http:img/videos/personalizar_url_tela_principal.mp4" target="_blank"><span class="fa fa-play-circle-o large"></span>  Personalizar URL da P&aacute;gina Inicial</a></li>
                            			</ul>
                    </li>
